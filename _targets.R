...
config_targets <- list(
  ...
  tar_file_read(
    name = p1_wqp_inventory_aoi_link,
    command = {
      if(data_version_stable){
        paste0(p0_AquaMatch_download_WQP_directory,
  ...
  tar_file_read(
    name = p1_char_names_crosswalk_link,
    command = {
      if(data_version_stable){
        paste0(p0_AquaMatch_download_WQP_directory,
  ...
  tar_target(
    name = p1_wqp_params,
    command = retrieve_data(link_table = p1_wqp_params_link,
                            folder_pattern = "1_inventory/out/"),
    packages = c("tidyverse", "googledrive")
  ),
  
  tar_target(
    name = p1_wqp_inventory_aoi,
    command = retrieve_data(link_table = p1_wqp_inventory_aoi_link,
                            folder_pattern = "1_inventory/out/"),
    packages = c("tidyverse", "googledrive")
  ),
  ...
  tar_target(
    name = p1_global_grid,
    command = retrieve_data(link_table = p1_global_grid_link,
                            folder_pattern = "1_inventory/out/"),
    packages = c("tidyverse", "googledrive")
  ),
  
  tar_target(
    name = p1_char_names_crosswalk,
    command = retrieve_data(link_table = p1_char_names_crosswalk_link,
                            folder_pattern = "1_inventory/out/"),
    packages = c("tidyverse", "googledrive")
  ),
  ...
  tar_target(
    name = p2_site_counts,
    command = retrieve_data(link_table = p2_site_counts_link,
  ...
  tar_target(
    ...
    command = retrieve_param_data(link_table = p2_wqp_data_aoi_out_links,
