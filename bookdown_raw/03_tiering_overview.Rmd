...
## NA values
Many columns related to the direct interoperability of data in the WQP often contain many `NA`s, specifically field and lab methodology and depth-related columns. A highly restrictive filtering of the WQP would result in very limited data, in part, due to the inconsistent entry of data from data providers. Therefore, we are building this dataset to resolve as many `NA`s as possible, but to also include `NA`s within an "inclusive" data.
