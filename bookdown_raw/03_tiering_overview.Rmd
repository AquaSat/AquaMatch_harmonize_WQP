...
+ Having a variety of methods with different levels of precision and accuracy that can be used to quantify the same parameter
+ Having a variety of names or descriptions of the same (e.g., analytical) method across different organizations
+ Containing data for one parameter obtained by multiple methods with varying levels of interoperability
