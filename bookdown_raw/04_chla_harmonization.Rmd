...
Below is a set of histograms showing the distribution of harmonized measurements (top) and CVs (bottom) broken down by `tier` ***after*** aggregating simultaneous records.
...
<img src="3_harmonize/out/chla_tier_cv_dists_postagg.png" alt="Distribution of chl *a* CVs by tier" width="650"/>

<br>

Lastly, a series of maps showing the geographic distribution of records by tier:

#### Conterminous US <img src="3_harmonize/out/chla_conterminous_us_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in the Conterminous US" width="650"/>

#### Alaska <img src="3_harmonize/out/chla_alaska_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in Alaska" width="650"/>

#### Hawaii <img src="3_harmonize/out/chla_hawaii_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in Hawaii" width="650"/>

#### American Samoa <img src="3_harmonize/out/chla_american_samoa_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in American Samoa" width="650"/>

#### Guam and the Commonwealth of the Northern Mariana Islands <img src="3_harmonize/out/chla_guam_marianas_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in Guam and the Commonwealth of the Northern Mariana Islands" width="650"/>

#### Puerto Rico and the United States Virgin Islands <img src="3_harmonize/out/chla_puerto_rico_virgin_islands_tier_hex_map.png" alt="Geographic distribution of chl *a* records by tier in Puerto Rico and the United States Virgin Islands" width="650"/>
