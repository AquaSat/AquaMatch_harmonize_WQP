...
### Keep only chlorophyll parameters
...
In this step we filter out records based on indications that they have failed data quality assurance or quality control for some reason provided by the data provider. We screen the following columns: `ActivityCommentText`, `ResultLaboratoryCommentText`, `ResultCommentText`, and `ResultMeasureValue`. Records with text that matches one of the following patterns are removed: "beyond accept", "cancelled", "contaminat", "error", "fail", "improper", "instrument down", "interference", "invalid", "no result", "no test", "not accept", "outside of accept", "problem", "QC EXCEEDED", "questionable", "suspect", "unable", "violation", "reject", "no data"

Below are pie charts breaking down the number of fail detections by column:
...
```{r echo=FALSE}
tibble(
  ResultMeasure.MeasureUnitCode = c("mg/l", "mg/L", "ppm", "ug/l", "ug/L", "mg/m3", "ppb", "mg/cm3", "ug/ml", "mg/ml", "ppt"),
