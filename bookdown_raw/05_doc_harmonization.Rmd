...
At this point we export a file (`3_harmonize/out/doc_analytical_tiering_record.csv`) that contains a record of how specific method text was tiered and how many row counts corresponded to each method.
...
<img src="3_harmonize/out/doc_tier_dists_postagg.png" alt="Distribution of DOC values by analytical tier" width="650"/>
