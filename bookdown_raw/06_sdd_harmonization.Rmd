...
Before finalizing the dataset we removed Secchi disk depth values that were beyond a realistic threshold. We used 80m as our cutoff for removal based on Gieskes et al. (1987).
