...
are column names from the dataset being referenced. Some of these names are defined within this bookdown and a
full list of definitions for columns present in the original WQP dataset can be found in Table 7
...
the same day by the same `organizationIndentifier` at the same location with the
